					...
					<form action="#" method="POST">
						...
						<div class="row mt-3">
							<div class="col-lg-3 mb-3">
								...
								<input type="text" class="form-control" name="name" id="name" placeholder="Ingrese el nombre del producto" value="{{ $order->product->name }}">
							</div>
							<div class="col-lg-3 mb-3">
								<label class="form-label" for="quantity">Cantidad del producto</label>
								<input type="number" min="1" class="form-control" name="quantity" id="quantity" placeholder="Ingrese la cantidad del producto" value="{{ $order->product->quantity }}">
							</div>
							<div class="col-lg-3">
								<div class="mb-3 input-group">
									...
									<div class="input-group">
										...
										<input type="text" id="unit_price" class="form-control" name="unit_price" placeholder="Ingrese el precio unitario" value="{{ $order->product->unit_price }}">
							...
							<div class="col-lg-3">
								<div class="mb-3 input-group">
									...
									<div class="input-group">
										<span class="input-group-text">$</span>
										<input type="text" id="net_price" class="form-control" name="net_price" placeholder="Ingrese el precio neto" value="{{ $order->product->net_price }}">
										<span class="input-group-text">.00</span>
									</div>
								</div>
							</div>
						...
						<div class="row">
							<div class="col-lg-12 mt-2">
								...
								<textarea class="form-control" name="description" id="description" rows="5" placeholder="Ingrese la descripción del producto..." style="resize: none;">{{ $order->product->description }}</textarea>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-lg-12 mt-4">
								...
								<textarea class="form-control" name="observations" id="observations" rows="5" placeholder="Ingrese la descripción del producto..." style="resize: none;">{{ $order->product->observations }}</textarea>
							</div>
						</div>
						...
						<div class="row mt-4">
							<div class="col-lg-3">
								...
								<div class="mb-3 input-group">
									<div class="col-md-12">
										<input class="form-control" type="date" id="date_of_sale" value="{{ date('Y-m-d', strtotime($order->product->created_at)) }}">
									</div>
								</div>
							</div>
							<div class="col-lg-3">
