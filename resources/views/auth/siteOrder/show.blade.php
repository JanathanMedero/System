						...
						<div class="col-12 col-lg-8">
							<div class="row">
								<div class="d-flex flex-column flex-sm-row justify-content-center justify-content-md-end">
									...
									<button type="button" class="btn rounded-pill btn-dark mt-3 mt-sm-0" data-bs-toggle="modal" data-bs-target="#advance">
									...
									<button type="button" class="btn rounded-pill btn-success my-3 my-sm-0" data-bs-toggle="modal" data-bs-target="#add-product">
